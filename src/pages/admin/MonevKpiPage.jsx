                ...
                <div className="bg-white p-6 rounded-lg shadow-md animate-fade-in-down">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-4 border-t pt-4">
                            ...
                            <div><label className="block text-sm font-medium">PDS Akun</label><input type="number" name="nasabah_akun" value={formData.nasabah_akun} onChange={handleChange} placeholder="Angka" className="w-full p-2 border rounded-md" /></div>
                            <div><label className="block text-sm font-medium">PDS Transaksi</label><input type="number" name="nasabah_transaksi" value={formData.nasabah_transaksi} onChange={handleChange} placeholder="Angka" className="w-full p-2 border rounded-md" /></div>
                            <div><label className="block text-sm font-medium">UMI Corner (Rp)</label><input type="number" name="pds_umi_corner" value={formData.pds_umi_corner} onChange={handleChange} placeholder="Rp" className="w-full p-2 border rounded-md" /></div>
